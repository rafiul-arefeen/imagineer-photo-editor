...
def get_object_info(data):
    ...
    if x is not None and y is not None and w is not None and h is not None:
        create_transparent_rectangle(img_src, x, y, w, h, 'F:\Work\Web Development\imagineer-photo-editor\images\mask_image.png')
        return edit_image_with_openai(img_src, 'F:\Work\Web Development\imagineer-photo-editor\images\mask_image.png', user_prompt)
    else:
